...
/**
 * I had to rename the class BobTest to match the file name for a default
 * PHPUnit configuration to "see" the test class.  I'm sure this is solvable
 * with settings in a phpunit.xml file but I couldn't quickly find the
...
class BobTest extends PHPUnit\Framework\TestCase
{
    ...
    {
        $this->bob = new redisforlosers\exercism\php\Bob;
    }
